...
void calcularMetricasGPS(); // Calcula la distancia y el rumbo hacia el destino una vez por segundo para ahorrar CPU
void procesarLlegadaAlDestino(); // Detiene el motor, publica la alerta en MQTT y emite el sonido de meta alcanzada
